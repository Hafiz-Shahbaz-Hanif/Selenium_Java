...
- **Data-driven at scale.** ~105 `@Test` methods, most fed by a `@DataProvider`
...
| the-internet — dynamic DOM | 15 | dynamic loading (1 & 2), AJAX enable/disable & add/remove, notification message, status codes, infinite scroll |
